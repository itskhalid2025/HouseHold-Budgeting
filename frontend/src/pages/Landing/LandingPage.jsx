...
import TaglineSequential from './TaglineSequential';
import './LandingPage.css';

// Import images
import mobileLandImg from './mobile land.PNG';
import reportLandImg from './report land.PNG';
import aiAdvisorLandImg from './ai advisor land.PNG';
    ...
    return (
        <div className="landing-page">
            ...
            >
                ...
                {/* PWA / Mobile Support Section */}
                <section className="landing-section landing-pwa-section">
                    <div className="pwa-content-wrapper">
                        <motion.div
                            className="pwa-text-content"
                        ...
                        >
                            <motion.h2
                                className="landing-section-title pwa-title"
                                style={{ textAlign: 'left', marginBottom: '1rem' }}
                            >
                                {isMobile ? "App Experience" : "Native App Experience"}
                            </motion.h2>
                            <h3 className="pwa-subtitle">No download required. Works offline.</h3>

                            <p className="pwa-description">
                                GrowWise is built as a Progressive Web App (PWA). This means you can install it directly from your browser
                                to your home screen for a full native app experience — without visiting an app store.
                            </p>

                            <ul className="landing-feature-list pwa-features">
                                <li><Zap size={18} /> Instant load times</li>
                                <li><Globe size={18} /> Works offline</li>
                                <li><Shield size={18} /> Secure & private</li>
                                <li><CheckCircle size={18} /> Auto-updates</li>
                            </ul>
                        </motion.div>

                        <motion.div
                            className="pwa-image-content"
                        ...
                        >
                            <div className="pwa-phone-mockup">
                                <img
                                    src={mobileLandImg}
                                    alt="GrowWise Mobile PWA Interface"
                                    className="pwa-screenshot"
                                />
                                <div className="pwa-glow"></div>
                            </div>
                        </motion.div>
                    </div>
                </section>
