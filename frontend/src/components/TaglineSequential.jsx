...
export default function TaglineSequential({ isMobile }) {
    // Full logic derived from user request:
    ...
    const containerStyle = {
        ...
        alignItems: "center",
        marginTop: "10px",
        flexWrap: "nowrap", // Force single line per request
        whiteSpace: "nowrap",
        gap: isMobile ? "0.3rem" : "0.6rem" // Slightly responsive gap
    };

    const textStyle = {
        color: "white",
        fontSize: isMobile ? "0.9rem" : "2.5rem", // Responsive font size
        fontWeight: 400,
