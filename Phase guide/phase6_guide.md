...
- **Personalized savings suggestions (ON REQUEST ONLY)** - User clicks button to get AI suggestions (UPDATED)
- Natural language chart generation
- LLM-as-judge evaluation for advice quality
- **Remaining Balance Calculation** - Show income - expenses - regular savings (NEW)
